...
meta_nums = {} # новый словарб, где ключи - слова, а значения - цифры

for key in nums: # заполняем словарь
    val = nums[key]
    meta_nums[val] = key
...
num = int(input())
a = []
a.append(num // 100 * 100) # выделяем цифры числа
a.append(((num // 10) % 10) * 10)
a.append(num % 10)
